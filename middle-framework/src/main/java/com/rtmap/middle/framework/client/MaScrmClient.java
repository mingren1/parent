...
@Component
@FeignClient(
        url = "${feign.crm.scrm-web-opr}",
        name = "scrmClienturl",
        configuration = FeignClientConfiguration.class,
        fallback = MaScrmClientFallback.class
)
public interface MaScrmClient {
    ...
    @Headers("Content-Type: application/json;charset=UTF-8")
    Result<IsMember> isMember(@RequestParam(name = "searchText") String searchText,
                              @RequestParam(name = "searchType") Integer searchType,
                              @RequestParam(name = "tenantId") Long tenantId,
                              @RequestParam(name = "tenantType") Integer tenantType);
    ...
    Result<CustomerDetailVO> getMember(@RequestParam("tenantId") Long tenantId,
                                       @RequestParam("tenantType") Integer tenantType,
    ...
    @Headers("Content-Type: application/json;charset=UTF-8")
    Result<UserInfoVO> getScoreByCid(@RequestParam("tenantType") Integer tenantType,
     ...
     * @param tenantType
     * @return
     * 查询类型 1：手机号，3：会员卡号，5：会员名，7：cid，4：openid，16：MAC地址，32：IDFA，64：IMEI
     */
    @RequestMapping(value = "/api/v1/customer/externalId", method = RequestMethod.GET)
    public Result<String> getExternalId(@RequestParam(name = "searchText") String searchText,
                                        @RequestParam(name = "searchType") Integer searchType, @RequestParam(name = "tenantId") Long tenantId,
                                        @RequestParam(name = "tenantType") Integer tenantType);
     ...
     * @return
     */
    @RequestMapping(value = "/api/v1/card/queryList", method = RequestMethod.POST,produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public Result<PageResponseVo<OutCardInfoVo>> queryList(@RequestBody CardInfoVo cardInfoVo);

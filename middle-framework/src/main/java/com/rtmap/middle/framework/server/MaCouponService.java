...
public interface MaCouponService {
    ...
    Result<CouponActivityDetatilVO> getCouponActivityDetail(@NotNull(message = "券id不能为空") @RequestParam(value = "id") Long id, @NotBlank(message = "券批id不能为空") @RequestParam(value = "couponActivityId") String couponActivityId);
    ...
    Result<List<QRCodeDetailVO>> getMyCouponsFromCardBag(@NotBlank(message = "openId 不能为空") @RequestParam(value = "openId") String openId);
